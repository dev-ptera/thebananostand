if (window.bananocoin.passwordUtils === undefined) {
  window.bananocoin.passwordUtils = {};
  ...
  window.bananocoin.passwordUtils.encryptData = encryptData;
  window.bananocoin.passwordUtils.decryptData = decryptData;
  window.bananocoin.passwordUtils.enabled = enabled;
}
