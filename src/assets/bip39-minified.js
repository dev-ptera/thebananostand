!(function () {
    return function e(a, r, t) {
        ...
        for (var i = 'function' == typeof require && require, n = 0; n < t.length; n++) o(t[n]);
        return o;
    };
})()(
    {
            ...
            function (e, a, r) {
                ...
                (r.byteLength = function (e) {
                    ...
                    (r.toByteArray = function (e) {
                        ...
                        for (r = 0; r < d; r += 4)
                            (a =
                                ...
                                (l[c++] = 255 & a);
                        2 === s &&
                        ((a = (o[e.charCodeAt(r)] << 2) | (o[e.charCodeAt(r + 1)] >> 4)), (l[c++] = 255 & a));
                        1 === s &&
                        ((a =
                            (o[e.charCodeAt(r)] << 10) |
                    ...
                    (r.fromByteArray = function (e) {
                        for (var a, r = e.length, o = r % 3, i = [], n = 0, s = r - o; n < s; n += 16383)
                            i.push(c(e, n, n + 16383 > s ? s : n + 16383));
                        1 === o
                            ? ((a = e[r - 1]), i.push(t[a >> 2] + t[(a << 4) & 63] + '=='))
                            : 2 === o &&
                            ((a = (e[r - 2] << 8) + e[r - 1]),
                ...
                function c(e, a, r) {
                    for (var o, i, n = [], s = a; s < r; s += 3)
                        (o = ((e[s] << 16) & 16711680) + ((e[s + 1] << 8) & 65280) + (255 & e[s + 2])),
                            n.push(t[((i = o) >> 18) & 63] + t[(i >> 12) & 63] + t[(i >> 6) & 63] + t[63 & i]);
                    return n.join('');
                }
        ...
        3: [
            ...
            {
                './wordlists/chinese_simplified.json': 5,
                './wordlists/chinese_traditional.json': 6,
                './wordlists/czech.json': 7,
                './wordlists/english.json': 8,
                './wordlists/french.json': 9,
                './wordlists/italian.json': 10,
                './wordlists/japanese.json': 11,
                './wordlists/korean.json': 12,
                './wordlists/portuguese.json': 13,
                './wordlists/spanish.json': 14,
            },
        ],
        4: [
            function (e, a, r) {
                    ...
                    (function () {
                        ...
                        function b(e) {
                            const a = (8 * e.length) / 32,
                                r = t('sha256').update(e).digest();
                            return m(Array.from(r)).slice(0, a);
                        }
                        function g(e) {
                            return 'mnemonic' + (e || '');
                        }
                        function v(e, r) {
                            if (!(r = r || s)) throw new Error(d);
                            const t = p(e).split(' ');
                            if (t.length % 3 != 0) throw new Error(l);
                            const o = t
                                    .map((e) => {
                                        const a = r.indexOf(e);
                                        if (-1 === a) throw new Error(l);
                        ...
                        function y(e, r) {
                            if ((a.isBuffer(e) || (e = a.from(e, 'hex')), !(r = r || s))) throw new Error(d);
                            if (e.length < 16) throw new TypeError(u);
                            if (e.length > 32) throw new TypeError(u);
                            if (e.length % 4 != 0) throw new TypeError(u);
                            const t = (m(Array.from(e)) + b(e)).match(/(.{1,11})/g).map((e) => {
                                const a = h(e);
                                return r[a];
                            });
                            return 'あいこくしん' === r[0] ? t.join('　') : t.join(' ');
                        }
                        (r.mnemonicToSeedSync = function (e, r) {
                            const t = a.from(p(e), 'utf8'),
                                i = a.from(g(p(r)), 'utf8');
                            return o.pbkdf2Sync(t, i, 2048, 64, 'sha512');
                        }),
                            (r.mnemonicToSeed = function (e, r) {
                                return Promise.resolve().then(() =>
                                    (function (e, a, r, t, i) {
                                        return Promise.resolve().then(
                                            () =>
                                                new Promise((n, s) => {
                                                    o.pbkdf2(e, a, r, t, i, (e, a) => (e ? s(e) : n(a)));
                                                })
                                        );
                                    })(a.from(p(e), 'utf8'), a.from(g(p(r)), 'utf8'), 2048, 64, 'sha512')
                                );
                            }),
                            (r.mnemonicToEntropy = v),
                            (r.entropyToMnemonic = y),
                            (r.generateMnemonic = function (e, a, r) {
                                if ((e = e || 128) % 32 != 0) throw new TypeError(u);
                                return y((a = a || i)(e / 8), r);
                            }),
                            (r.validateMnemonic = function (e, a) {
                                try {
                                    v(e, a);
                                } catch (e) {
                                    return !1;
                            ...
                            (r.setDefaultWordlist = function (e) {
                                const a = n.wordlists[e];
                                if (!a) throw new Error('Could not find wordlist for language "' + e + '"');
                                s = a;
                            }),
                            (r.getDefaultWordlist = function () {
                                if (!s) throw new Error('No Default Wordlist set');
                                return Object.keys(n.wordlists).filter(
                                    (e) => 'JA' !== e && 'EN' !== e && n.wordlists[e].every((e, a) => e === s[a])
                                )[0];
                            });
                        var k = e('./_wordlists');
                        r.wordlists = k.wordlists;
                    }.call(this));
                }.call(this, e('buffer').Buffer));
            },
            { './_wordlists': 3, buffer: 16, 'create-hash': 18, pbkdf2: 40, randombytes: 47 },
        ],
        5: [
            function (e, a, r) {
                a.exports = [
        ...
        16: [
                ...
                (function (a) {
                    (function () {
                        ...
                        function s(e, a, r) {
                            ...
                            if (null != t && t !== e) return n.from(t, a, r);
                            var o = (function (e) {
                                if (n.isBuffer(e)) {
                                    var a = 0 | d(e.length),
                                        r = i(a);
                                ...
                                if (void 0 !== e.length)
                                    return 'number' != typeof e.length || N(e.length) ? i(0) : c(e);
                            ...
                            if (
                                ...
                                return n.from(e[Symbol.toPrimitive]('string'), a, r);
                            throw new TypeError(
                                'The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type ' +
                                typeof e
                            );
                        ...
                        function c(e) {
                            for (var a = e.length < 0 ? 0 : 0 | d(e.length), r = i(a), t = 0; t < a; t += 1)
                                r[t] = 255 & e[t];
                            return r;
                        }
                        function d(e) {
                        ...
                        function h(e, a, r, t, o) {
                            ...
                            if (('string' == typeof a && (a = n.from(a, t)), n.isBuffer(a)))
                                return 0 === a.length ? -1 : m(e, a, r, t, o);
                            if ('number' == typeof a)
                                return (
                                    (a &= 255),
                                        'function' == typeof Uint8Array.prototype.indexOf
                                            ? o
                                                ? Uint8Array.prototype.indexOf.call(e, a, r)
                                                : Uint8Array.prototype.lastIndexOf.call(e, a, r)
                                            : m(e, [a], r, t, o)
                                );
                        ...
                        function _(e, a, r, t) {
                            return U(
                                (function (e, a) {
                                    for (var r, t, o, i = [], n = 0; n < e.length && !((a -= 2) < 0); ++n)
                                        (r = e.charCodeAt(n)), (t = r >> 8), (o = r % 256), i.push(o), i.push(t);
                                    return i;
                                })(a, e.length - r),
                                e,
                                r,
                        ...
                        function z(e, a, r) {
                            ...
                            for (var t = [], o = a; o < r; ) {
                                ...
                                null === c
                                    ? ((c = 65533), (d = 1))
                                    : c > 65535 &&
                                    ((c -= 65536), t.push(((c >>> 10) & 1023) | 55296), (c = 56320 | (1023 & c))),
                                    t.push(c),
                                    (o += d);
                            }
                            return (function (e) {
                                var a = e.length;
                                if (a <= j) return String.fromCharCode.apply(String, e);
                                var r = '',
                                    t = 0;
                                for (; t < a; ) r += String.fromCharCode.apply(String, e.slice(t, (t += j)));
                                return r;
                            })(t);
                        }
                        (r.kMaxLength = o),
                        ...
                        Object.defineProperty(n, Symbol.species, {
                            ...
                            (n.compare = function (e, a) {
                                if (
                                    (P(e, Uint8Array) && (e = n.from(e, e.offset, e.byteLength)),
                                    P(a, Uint8Array) && (a = n.from(a, a.offset, a.byteLength)),
                            ...
                            (n.concat = function (e, a) {
                                ...
                                var r;
                                if (void 0 === a) for (a = 0, r = 0; r < e.length; ++r) a += e[r].length;
                                var t = n.allocUnsafe(a),
                                    o = 0;
                                for (r = 0; r < e.length; ++r) {
                                    var i = e[r];
                                    if ((P(i, Uint8Array) && (i = n.from(i)), !n.isBuffer(i)))
                                        throw new TypeError('"list" argument must be an Array of Buffers');
                                    i.copy(t, o), (o += i.length);
                                }
                                return t;
                            }),
                            (n.byteLength = p),
                            ...
                            (n.prototype.compare = function (e, a, r, t, o) {
                                if ((P(e, Uint8Array) && (e = n.from(e, e.offset, e.byteLength)), !n.isBuffer(e)))
                                    throw new TypeError(
                                ...
                                if (
                                    ...
                                    a < 0 || r > e.length || t < 0 || o > this.length)
                                )
                            ...
                            (n.prototype.includes = function (e, a, r) {
                                return -1 !== this.indexOf(e, a, r);
                            }),
                            (n.prototype.indexOf = function (e, a, r) {
                                return h(this, e, a, r, !0);
                            }),
                            (n.prototype.lastIndexOf = function (e, a, r) {
                                return h(this, e, a, r, !1);
                            }),
                            (n.prototype.write = function (e, a, r, t) {
                                ...
                                if (
                                    ((void 0 === r || r > o) && (r = o),
                                    (e.length > 0 && (r < 0 || a < 0)) || a > this.length)
                                )
                        ...
                        function S(e, a, r) {
                            var t = e.length;
                            (!a || a < 0) && (a = 0), (!r || r < 0 || r > t) && (r = t);
                            for (var o = '', i = a; i < r; ++i) o += O(e[i]);
                            return o;
                        }
                        function q(e, a, r) {
                            for (var t = e.slice(a, r), o = '', i = 0; i < t.length; i += 2)
                                o += String.fromCharCode(t[i] + 256 * t[i + 1]);
                            return o;
                        }
                        function R(e, a, r) {
                            if (e % 1 != 0 || e < 0) throw new RangeError('offset is not uint');
                            if (e + a > r) throw new RangeError('Trying to access beyond buffer length');
                        }
                        function T(e, a, r, t, o, i) {
                            if (!n.isBuffer(e)) throw new TypeError('"buffer" argument must be a Buffer instance');
                            if (a > o || a < i) throw new RangeError('"value" argument is out of bounds');
                            if (r + t > e.length) throw new RangeError('Index out of range');
                        }
                        function L(e, a, r, t, o, i) {
                            if (r + t > e.length) throw new RangeError('Index out of range');
                            if (r < 0) throw new RangeError('Index out of range');
                        }
                        function A(e, a, r, o, i) {
                            return (a = +a), (r >>>= 0), i || L(e, 0, r, 4), t.write(e, a, r, o, 23, 4), r + 4;
                        }
                        function B(e, a, r, o, i) {
                            return (a = +a), (r >>>= 0), i || L(e, 0, r, 8), t.write(e, a, r, o, 52, 8), r + 8;
                        }
                        (n.prototype.slice = function (e, a) {
                            var r = this.length;
                            (e = ~~e) < 0 ? (e += r) < 0 && (e = 0) : e > r && (e = r),
                                (a = void 0 === a ? r : ~~a) < 0 ? (a += r) < 0 && (a = 0) : a > r && (a = r),
                            a < e && (a = e);
                            var t = this.subarray(e, a);
                            return (t.__proto__ = n.prototype), t;
                        }),
                            (n.prototype.readUIntLE = function (e, a, r) {
                                (e >>>= 0), (a >>>= 0), r || R(e, a, this.length);
                                for (var t = this[e], o = 1, i = 0; ++i < a && (o *= 256); ) t += this[e + i] * o;
                                return t;
                            }),
                            (n.prototype.readUIntBE = function (e, a, r) {
                                (e >>>= 0), (a >>>= 0), r || R(e, a, this.length);
                                for (var t = this[e + --a], o = 1; a > 0 && (o *= 256); ) t += this[e + --a] * o;
                                return t;
                            }),
                            (n.prototype.readUInt8 = function (e, a) {
                                return (e >>>= 0), a || R(e, 1, this.length), this[e];
                            }),
                            (n.prototype.readUInt16LE = function (e, a) {
                                return (e >>>= 0), a || R(e, 2, this.length), this[e] | (this[e + 1] << 8);
                            }),
                            (n.prototype.readUInt16BE = function (e, a) {
                                return (e >>>= 0), a || R(e, 2, this.length), (this[e] << 8) | this[e + 1];
                            }),
                            ...
                            (n.prototype.readIntLE = function (e, a, r) {
                                (e >>>= 0), (a >>>= 0), r || R(e, a, this.length);
                                for (var t = this[e], o = 1, i = 0; ++i < a && (o *= 256); ) t += this[e + i] * o;
                                return t >= (o *= 128) && (t -= Math.pow(2, 8 * a)), t;
                            }),
                            (n.prototype.readIntBE = function (e, a, r) {
                                (e >>>= 0), (a >>>= 0), r || R(e, a, this.length);
                                for (var t = a, o = 1, i = this[e + --t]; t > 0 && (o *= 256); ) i += this[e + --t] * o;
                            ...
                            (n.prototype.readFloatLE = function (e, a) {
                                return (e >>>= 0), a || R(e, 4, this.length), t.read(this, e, !0, 23, 4);
                            }),
                            (n.prototype.readFloatBE = function (e, a) {
                                return (e >>>= 0), a || R(e, 4, this.length), t.read(this, e, !1, 23, 4);
                            }),
                            (n.prototype.readDoubleLE = function (e, a) {
                                return (e >>>= 0), a || R(e, 8, this.length), t.read(this, e, !0, 52, 8);
                            }),
                            (n.prototype.readDoubleBE = function (e, a) {
                                return (e >>>= 0), a || R(e, 8, this.length), t.read(this, e, !1, 52, 8);
                            }),
                            (n.prototype.writeUIntLE = function (e, a, r, t) {
                                ((e = +e), (a >>>= 0), (r >>>= 0), t) || T(this, e, a, r, Math.pow(2, 8 * r) - 1, 0);
                                var o = 1,
                                    i = 0;
                                for (this[a] = 255 & e; ++i < r && (o *= 256); ) this[a + i] = (e / o) & 255;
                                return a + r;
                            }),
                            (n.prototype.writeUIntBE = function (e, a, r, t) {
                                ((e = +e), (a >>>= 0), (r >>>= 0), t) || T(this, e, a, r, Math.pow(2, 8 * r) - 1, 0);
                                var o = r - 1,
                                    i = 1;
                                for (this[a + o] = 255 & e; --o >= 0 && (i *= 256); ) this[a + o] = (e / i) & 255;
                                return a + r;
                            }),
                            (n.prototype.writeUInt8 = function (e, a, r) {
                                return (e = +e), (a >>>= 0), r || T(this, e, a, 1, 255, 0), (this[a] = 255 & e), a + 1;
                            }),
                            (n.prototype.writeUInt16LE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 2, 65535, 0),
                                        (this[a] = 255 & e),
                                        (this[a + 1] = e >>> 8),
                                    a + 2
                                );
                            }),
                            (n.prototype.writeUInt16BE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 2, 65535, 0),
                            ...
                            (n.prototype.writeUInt32LE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 4, 4294967295, 0),
                                        (this[a + 3] = e >>> 24),
                                        (this[a + 2] = e >>> 16),
                                        (this[a + 1] = e >>> 8),
                                        (this[a] = 255 & e),
                            ...
                            (n.prototype.writeUInt32BE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 4, 4294967295, 0),
                            ...
                            (n.prototype.writeIntLE = function (e, a, r, t) {
                                if (((e = +e), (a >>>= 0), !t)) {
                                ...
                                var i = 0,
                                    n = 1,
                                    s = 0;
                                for (this[a] = 255 & e; ++i < r && (n *= 256); )
                                    e < 0 && 0 === s && 0 !== this[a + i - 1] && (s = 1),
                                        (this[a + i] = (((e / n) >> 0) - s) & 255);
                                return a + r;
                            }),
                            (n.prototype.writeIntBE = function (e, a, r, t) {
                                if (((e = +e), (a >>>= 0), !t)) {
                                    var o = Math.pow(2, 8 * r - 1);
                                    T(this, e, a, r, o - 1, -o);
                                }
                            ...
                            (n.prototype.writeInt8 = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 1, 127, -128),
                                    e < 0 && (e = 255 + e + 1),
                                        (this[a] = 255 & e),
                                    a + 1
                                );
                            }),
                            (n.prototype.writeInt16LE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 2, 32767, -32768),
                                        (this[a] = 255 & e),
                                        (this[a + 1] = e >>> 8),
                                    a + 2
                                );
                            }),
                            (n.prototype.writeInt16BE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 2, 32767, -32768),
                            ...
                            (n.prototype.writeInt32LE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 4, 2147483647, -2147483648),
                                        (this[a] = 255 & e),
                                        (this[a + 1] = e >>> 8),
                                        (this[a + 2] = e >>> 16),
                                        (this[a + 3] = e >>> 24),
                            ...
                            (n.prototype.writeInt32BE = function (e, a, r) {
                                return (
                                    (e = +e),
                                        (a >>>= 0),
                                    r || T(this, e, a, 4, 2147483647, -2147483648),
                            ...
                            (n.prototype.writeFloatLE = function (e, a, r) {
                                return A(this, e, a, !0, r);
                            }),
                            (n.prototype.writeFloatBE = function (e, a, r) {
                                return A(this, e, a, !1, r);
                            }),
                            (n.prototype.writeDoubleLE = function (e, a, r) {
                                return B(this, e, a, !0, r);
                            }),
                            (n.prototype.writeDoubleBE = function (e, a, r) {
                                return B(this, e, a, !1, r);
                            }),
                            (n.prototype.copy = function (e, a, r, t) {
                                ...
                                if (this === e && 'function' == typeof Uint8Array.prototype.copyWithin)
                                    this.copyWithin(a, r, t);
                                else if (this === e && r < a && a < t)
                                    for (var i = o - 1; i >= 0; --i) e[i + a] = this[i + r];
                                else Uint8Array.prototype.set.call(e, this.subarray(r, t), a);
                                return o;
                            }),
                            (n.prototype.fill = function (e, a, r, t) {
                                if ('string' == typeof e) {
                                    if (
                                        ('string' == typeof a
                                            ? ((t = a), (a = 0), (r = this.length))
                                            : 'string' == typeof r && ((t = r), (r = this.length)),
                                        void 0 !== t && 'string' != typeof t)
                                    )
                                        throw new TypeError('encoding must be a string');
                                    if ('string' == typeof t && !n.isEncoding(t))
                                        throw new TypeError('Unknown encoding: ' + t);
                                    if (1 === e.length) {
                                        var o = e.charCodeAt(0);
                                        (('utf8' === t && o < 128) || 'latin1' === t) && (e = o);
                                    }
                                } else 'number' == typeof e && (e &= 255);
                                if (a < 0 || this.length < a || this.length < r)
                                    throw new RangeError('Out of range index');
                                if (r <= a) return this;
                                var i;
                                if (
                                    ...
                                    var s = n.isBuffer(e) ? e : n.from(e, t),
                                        l = s.length;
                                    if (0 === l)
                                        throw new TypeError('The value "' + e + '" is invalid for argument "value"');
                                    for (i = 0; i < r - a; ++i) this[i + a] = s[i % l];
                                }
                                return this;
                            });
                        var M = /[^+/0-9A-Za-z-_]/g;
                        ...
                        function I(e, a) {
                            ...
                            for (var t = e.length, o = null, i = [], n = 0; n < t; ++n) {
                                if ((r = e.charCodeAt(n)) > 55295 && r < 57344) {
                                    ...
                                    if (r < 56320) {
                                        (a -= 3) > -1 && i.push(239, 191, 189), (o = r);
                                        continue;
                                    }
                                    r = 65536 + (((o - 55296) << 10) | (r - 56320));
                                } else o && (a -= 3) > -1 && i.push(239, 191, 189);
                                if (((o = null), r < 128)) {
                                    if ((a -= 1) < 0) break;
                                    i.push(r);
                                } else if (r < 2048) {
            ...
            { 'base64-js': 2, buffer: 16, ieee754: 37 },
        ],
        17: [
            function (e, a, r) {
                ...
                e('inherits')(n, o),
                    (n.prototype.update = function (e, a, r) {
                    ...
                    (n.prototype._toString = function (e, a, r) {
                        if ((this._decoder || ((this._decoder = new i(a)), (this._encoding = a)), this._encoding !== a))
                            throw new Error("can't switch encodings");
                        var t = this._decoder.write(e);
                        return r && (t += this._decoder.end()), t;
                    }),
                    (a.exports = n);
            },
            { inherits: 38, 'safe-buffer': 49, stream: 58, string_decoder: 73 },
        ],
        18: [
            function (e, a, r) {
                'use strict';
            ...
            { 'cipher-base': 17, inherits: 38, 'md5.js': 39, ripemd160: 48, 'sha.js': 51 },
        ],
        19: [
            function (e, a, r) {
                var t = e('md5.js');
        ...
        20: [
            function (e, a, r) {
                ...
                (a.exports = s),
                    (a.exports.once = function (e, a) {
                        return new Promise(function (r, t) {
                            function o(r) {
                                e.removeListener(a, i), t(r);
                            }
                            function i() {
                            ...
                            'error' !== a &&
                            (function (e, a, r) {
                                'function' == typeof e.on && b(e, 'error', a, r);
                            })(e, o, { once: !0 });
                        });
                    }),
                    (s.EventEmitter = s),
                    ...
                    if (
                        (u(r),
                            void 0 === (i = e._events)
                                ...
                                (e.emit('newListener', a, r.listener ? r.listener : r), (i = e._events)),
                                    (n = i[a])),
                        void 0 === n)
                    )
                        (n = i[a] = r), ++e._eventsCount;
                    else if (
                        ('function' == typeof n ? (n = i[a] = t ? [r, n] : [n, r]) : t ? n.unshift(r) : n.push(r),
                ...
                function p(e, a, r) {
                    var t = { fired: !1, wrapFn: void 0, target: e, type: a, listener: r },
                        o = function () {
                            if (!this.fired)
                                return (
                ...
                function b(e, a, r, t) {
                    if ('function' == typeof e.on) t.once ? e.once(a, r) : e.on(a, r);
                    else {
                        if ('function' != typeof e.addEventListener)
                            throw new TypeError(
                                'The "emitter" argument must be of type EventEmitter. Received type ' + typeof e
                            );
                        e.addEventListener(a, function o(i) {
                            t.once && e.removeEventListener(a, o), r(i);
                        });
                    }
                }
                Object.defineProperty(s, 'defaultMaxListeners', {
                    ...
                    (s.prototype.emit = function (e) {
                        ...
                        var t = 'error' === e,
                            o = this._events;
                        if (void 0 !== o) t = t && void 0 === o.error;
                        else if (!t) return !1;
                        if (t) {
                            var n;
                        ...
                        if ('function' == typeof l) i(l, this, a);
                        else {
                            var u = l.length,
                                c = m(l, u);
                            for (r = 0; r < u; ++r) i(c[r], this, a);
                        }
                        return !0;
                    }),
                    (s.prototype.addListener = function (e, a) {
                        return d(this, e, a, !1);
                    }),
                    (s.prototype.on = s.prototype.addListener),
                    (s.prototype.prependListener = function (e, a) {
                        return d(this, e, a, !0);
                    }),
                    (s.prototype.once = function (e, a) {
                        return u(a), this.on(e, p(this, e, a)), this;
                    }),
                    (s.prototype.prependOnceListener = function (e, a) {
                        return u(a), this.prependListener(e, p(this, e, a)), this;
                    }),
                    (s.prototype.removeListener = function (e, a) {
                        var r, t, o, i, n;
                        ...
                        if (r === a || r.listener === a)
                            0 == --this._eventsCount
                                ...
                                : (delete t[e], t.removeListener && this.emit('removeListener', e, r.listener || a));
                            ...
                            1 === r.length && (t[e] = r[0]),
                            void 0 !== t.removeListener && this.emit('removeListener', e, n || a);
                        }
                        return this;
                    }),
                    ...
                    (s.prototype.removeAllListeners = function (e) {
                        ...
                        if (0 === arguments.length) {
                            ...
                            for (t = 0; t < i.length; ++t)
                                'removeListener' !== (o = i[t]) && this.removeAllListeners(o);
                            return (
                        ...
                        else if (void 0 !== a) for (t = a.length - 1; t >= 0; t--) this.removeListener(e, a[t]);
                        return this;
                    }),
        ...
        21: [
            function (e, a, r) {
                ...
                e('inherits')(i, o),
                    (i.prototype._transform = function (e, a, r) {
                        var t = null;
                        try {
                            this.update(e, a);
                        } catch (e) {
                    ...
                    (i.prototype.update = function (e, a) {
                        if (
                            ((function (e, a) {
                                if (!t.isBuffer(e) && 'string' != typeof e)
                                    throw new TypeError(a + ' must be a string or a buffer');
                            })(e, 'Data'),
                                this._finalized)
                        )
                            throw new Error('Digest already called');
                        t.isBuffer(e) || (e = t.from(e, a));
                        for (var r = this._block, o = 0; this._blockOffset + e.length - o >= this._blockSize; ) {
                            for (var i = this._blockOffset; i < this._blockSize; ) r[i++] = e[o++];
                    ...
                    (i.prototype.digest = function (e) {
                        ...
                        this._finalized = !0;
                        var a = this._digest();
                        void 0 !== e && (a = a.toString(e)), this._block.fill(0), (this._blockOffset = 0);
            ...
            { inherits: 38, 'readable-stream': 36, 'safe-buffer': 49 },
        ],
        22: [
            function (e, a, r) {
                'use strict';
                ...
                function o(e, a, r) {
                    ...
                    var o = (function (e) {
                        ...
                        return (
                            (t = e),
                                ((r = o).prototype = Object.create(t.prototype)),
                    ...
                    if (Array.isArray(e)) {
                        ...
                        return (
                            (e = e.map(function (e) {
                                ...
                                r > 2
                                    ? 'one of '.concat(a, ' ').concat(e.slice(0, r - 1).join(', '), ', or ') + e[r - 1]
                                    : 2 === r
                ...
                o(
                    ...
                    o(
                        ...
                        function (e, a, r) {
                            var t, o, n, s;
                            if (
                                ('string' == typeof a && ((o = 'not '), a.substr(!n || n < 0 ? 0 : +n, o.length) === o)
                                ...
                                s = 'The '.concat(e, ' ').concat(t, ' ').concat(i(a, 'type'));
                            else {
                                var l = (function (e, a, r) {
                                    ...
                                    ? 'property'
                                    : 'argument';
                                s = 'The "'.concat(e, '" ').concat(l, ' ').concat(t, ' ').concat(i(a, 'type'));
                            }
        ...
        23: [
            function (e, a, r) {
                (function (r) {
                    (function () {
                        ...
                        e('inherits')(u, o);
                        for (var n = t(i.prototype), s = 0; s < n.length; s++) {
                            var l = n[s];
            ...
            { './_stream_readable': 25, './_stream_writable': 27, _process: 46, inherits: 38 },
        ],
        24: [
            function (e, a, r) {
                'use strict';
            ...
            { './_stream_transform': 26, inherits: 38 },
        ],
        25: [
            function (e, a, r) {
                (function (r, t) {
                    (function () {
                        ...
                        function j(a, r, t) {
                            (o = o || e('./_stream_duplex')),
                                (a = a || {}),
                            'boolean' != typeof t && (t = r instanceof o),
                                (this.objectMode = !!a.objectMode),
                            t && (this.objectMode = this.objectMode || !!a.readableObjectMode),
                                (this.highWaterMark = b(this, a, 'readableHighWaterMark', t)),
                                (this.buffer = new h()),
                                (this.length = 0),
                                (this.pipes = null),
                                (this.pipesCount = 0),
                            ...
                            (d || (d = e('string_decoder/').StringDecoder),
                                (this.decoder = new d(a.encoding)),
                                (this.encoding = a.encoding));
                        }
                        function x(a) {
                            if (((o = o || e('./_stream_duplex')), !(this instanceof x))) return new x(a);
                            var r = this instanceof o;
                            (this._readableState = new j(a, this, r)),
                                (this.readable = !0),
                            a &&
                        ...
                        function E(e, a, r, t, o) {
                            u('readableAddChunk', a);
                            var i,
                                n = e._readableState;
                            if (null === a)
                                (n.reading = !1),
                                    (function (e, a) {
                                        if ((u('onEofChunk'), a.ended)) return;
                                        if (a.decoder) {
                                            var r = a.decoder.end();
                                            r &&
                                            r.length &&
                                        ...
                                        (a.ended = !0),
                                            a.sync
                                                ? T(e)
                                                : ((a.needReadable = !1),
                                                a.emittedReadable || ((a.emittedReadable = !0), L(e)));
                                    })(e, n);
                            else if (
                                (o ||
                                (i = (function (e, a) {
                                    ...
                                    void 0 === a ||
                                    e.objectMode ||
                                    (r = new v('chunk', ['string', 'Buffer', 'Uint8Array'], a));
                                    var t;
                                    return r;
                                })(n, a)),
                                    i)
                                ...
                                if (
                                    ('string' == typeof a ||
                                    n.objectMode ||
                                    Object.getPrototypeOf(a) === s.prototype ||
                                    (a = (function (e) {
                                        return s.from(e);
                                    })(a)),
                                        t)
                                )
                                    n.endEmitted ? w(e, new _()) : S(e, n, a, !0);
                                else if (n.ended) w(e, new y());
                                else {
                                    if (n.destroyed) return !1;
                                    (n.reading = !1),
                                        n.decoder && !r
                                            ? ((a = n.decoder.write(a)),
                                                n.objectMode || 0 !== a.length ? S(e, n, a, !1) : A(e, n))
                                            : S(e, n, a, !1);
                                }
                            else t || ((n.reading = !1), A(e, n));
                        ...
                        Object.defineProperty(x.prototype, 'destroyed', {
                            ...
                            (x.prototype._destroy = function (e, a) {
                                a(e);
                            }),
                            (x.prototype.push = function (e, a) {
                                var r,
                                ...
                                return (
                                    t.objectMode
                                        ? (r = !0)
                                        : 'string' == typeof e &&
                                        ((a = a || t.defaultEncoding) !== t.encoding &&
                                        ((e = s.from(e, a)), (a = '')),
                                            (r = !0)),
                                        E(this, e, a, !1, r)
                                );
                            ...
                            (x.prototype.setEncoding = function (a) {
                                d || (d = e('string_decoder/').StringDecoder);
                                var r = new d(a);
                                (this._readableState.decoder = r),
                                    (this._readableState.encoding = this._readableState.decoder.encoding);
                                for (var t = this._readableState.buffer.head, o = ''; null !== t; )
                                    (o += r.write(t.data)), (t = t.next);
                                return (
                        ...
                        function T(e) {
                            ...
                            u('emitReadable', a.needReadable, a.emittedReadable),
                                (a.needReadable = !1),
                            a.emittedReadable ||
                            (u('emitReadable', a.flowing), (a.emittedReadable = !0), r.nextTick(L, e));
                        }
                        function L(e) {
                            var a = e._readableState;
                            u('emitReadable_', a.destroyed, a.length, a.ended),
                            a.destroyed ||
                            (!a.length && !a.ended) ||
                        ...
                        function A(e, a) {
                            a.readingMore || ((a.readingMore = !0), r.nextTick(B, e, a));
                        }
                        function B(e, a) {
                            for (
                                ;
                                !a.reading && !a.ended && (a.length < a.highWaterMark || (a.flowing && 0 === a.length));

                            ) {
                                var r = a.length;
                                if ((u('maybeReadMore read 0'), e.read(0), r === a.length)) break;
                            }
                            a.readingMore = !1;
                        }
                        function M(e) {
                        ...
                        function C(e) {
                            var a = e._readableState;
                            for (u('flow', a.flowing); a.flowing && null !== e.read(); );
                        }
                        function U(e, a) {
                            return 0 === a.length
                                ? null
                        ...
                        function P(e) {
                            var a = e._readableState;
                            u('endReadable', a.endEmitted), a.endEmitted || ((a.ended = !0), r.nextTick(N, a, e));
                        }
                        function N(e, a) {
                            if (
                                ...
                                !e.endEmitted &&
                                0 === e.length &&
                                ((e.endEmitted = !0), (a.readable = !1), a.emit('end'), e.autoDestroy))
                            ) {
                        ...
                        (x.prototype.read = function (e) {
                            ...
                            if (
                                ...
                                0 === e &&
                                a.needReadable &&
                                ((0 !== a.highWaterMark ? a.length >= a.highWaterMark : a.length > 0) || a.ended))
                            )
                                return (
                                    u('read: emitReadable', a.length, a.ended),
                                        0 === a.length && a.ended ? P(this) : T(this),
                                        null
                                );
                            if (0 === (e = R(e, a)) && a.ended) return 0 === a.length && P(this), null;
                            var t,
                                o = a.needReadable;
                            return (
                                u('need readable', o),
                                ...
                                u('length less than watermark', (o = !0)),
                                    a.ended || a.reading
                                        ...
                                        0 === a.length && (a.needReadable = !0),
                                            ...
                                            (a.sync = !1),
                                        a.reading || (e = R(r, a))),
                                    null === (t = e > 0 ? U(e, a) : null)
                                        ? ((a.needReadable = a.length <= a.highWaterMark), (e = 0))
                                        : ((a.length -= e), (a.awaitDrain = 0)),
                                0 === a.length && (a.ended || (a.needReadable = !0), r !== e && a.ended && P(this)),
                            ...
                            (x.prototype.pipe = function (e, a) {
                                ...
                                (o.pipesCount += 1), u('pipe count=%d opts=%j', o.pipesCount, a);
                                var n = (!a || !1 !== a.end) && e !== r.stdout && e !== r.stderr ? l : b;
                                function s(a, r) {
                                    u('onunpipe'),
                                    a === t &&
                                    r &&
                                ...
                                o.endEmitted ? r.nextTick(n) : t.once('end', n), e.on('unpipe', s);
                                var c = (function (e) {
                                    return function () {
                                        var a = e._readableState;
                                        u('pipeOnDrain', a.awaitDrain),
                                        a.awaitDrain && a.awaitDrain--,
                                        0 === a.awaitDrain && i(e, 'data') && ((a.flowing = !0), C(e));
                                    };
                                })(t);
                                e.on('drain', c);
                                var d = !1;
                                ...
                                function f(a) {
                                    u('onerror', a), b(), e.removeListener('error', f), 0 === i(e, 'error') && w(e, a);
                                }
                                function h() {
                                ...
                                return (
                                    t.on('data', p),
                                        (function (e, a, r) {
                                            if ('function' == typeof e.prependListener) return e.prependListener(a, r);
                                        ...
                                        e.once('finish', m),
                                        e.emit('pipe', t),
                                    o.flowing || (u('pipe resume'), t.resume()),
                                        e
                                );
                            }),
                            (x.prototype.unpipe = function (e) {
                                ...
                                if (!e) {
                                    ...
                                    for (var i = 0; i < o; i++) t[i].emit('unpipe', this, { hasUnpiped: !1 });
                                    return this;
                                }
                                var n = D(a.pipes, e);
                                return -1 === n
                            ...
                            (x.prototype.on = function (e, a) {
                                var t = n.prototype.on.call(this, e, a),
                                    o = this._readableState;
                                return (
                                    'data' === e
                                        ...
                                        (o.endEmitted ||
                                            ...
                                            ((o.readableListening = o.needReadable = !0),
                                                ...
                                                o.length ? T(this) : o.reading || r.nextTick(O, this))),
                                        t
                                );
                            }),
                            (x.prototype.addListener = x.prototype.on),
                            (x.prototype.removeListener = function (e, a) {
                                var t = n.prototype.removeListener.call(this, e, a);
                                return 'readable' === e && r.nextTick(M, this), t;
                            }),
                            (x.prototype.removeAllListeners = function (e) {
                                var a = n.prototype.removeAllListeners.apply(this, arguments);
                                return ('readable' !== e && void 0 !== e) || r.nextTick(M, this), a;
                            }),
                            (x.prototype.resume = function () {
                                ...
                                return (
                                    ...
                                    (u('resume'),
                                        ...
                                        (function (e, a) {
                                            a.resumeScheduled || ((a.resumeScheduled = !0), r.nextTick(I, e, a));
                                        })(this, e)),
                                        (e.paused = !1),
                                        this
                                );
                            ...
                            (x.prototype.wrap = function (e) {
                                ...
                                for (var o in (e.on('end', function () {
                                    ...
                                    e.on('data', function (o) {
                                        ...
                                        r.objectMode && null == o) ||
                                        ((r.objectMode || (o && o.length)) && (a.push(o) || ((t = !0), e.pause())));
                                    }),
                                    e))
                                    void 0 === this[o] &&
                                    'function' == typeof e[o] &&
                                ...
                                return (
                                    (this._read = function (a) {
                                        u('wrapped _read', a), t && ((t = !1), e.resume());
                                    }),
                                        this
                                );
                            }),
                        ...
                        (x.prototype[Symbol.asyncIterator] = function () {
                            return void 0 === p && (p = e('./internal/streams/async_iterator')), p(this);
                        }),
                        ...
                        'function' == typeof Symbol &&
                        (x.from = function (a, r) {
                            return void 0 === f && (f = e('./internal/streams/from')), f(x, a, r);
                        });
                    }.call(this));
                }.call(
                    this,
        ...
        26: [
            function (e, a, r) {
                ...
                function u(e, a) {
                    ...
                    (r.writechunk = null), (r.writecb = null), null != a && this.push(a), t(e);
                ...
                e('inherits')(c, l),
                    (c.prototype.push = function (e, a) {
                        return (this._transformState.needTransform = !1), l.prototype.push.call(this, e, a);
                    }),
                    ...
                    (c.prototype._write = function (e, a, r) {
                        ...
                        if (((t.writecb = r), (t.writechunk = e), (t.writeencoding = a), !t.transforming)) {
                            var o = this._readableState;
            ...
            { '../errors': 22, './_stream_duplex': 23, inherits: 38 },
        ],
        27: [
            function (e, a, r) {
                (function (r, t) {
                    (function () {
                        ...
                        var c,
                            ...
                            p = e('./internal/streams/state').getHighWaterMark,
                            f = e('../errors').codes,
                        ...
                        function j(a, t, n) {
                            ...
                            'boolean' != typeof n && (n = t instanceof i),
                                (this.objectMode = !!a.objectMode),
                            n && (this.objectMode = this.objectMode || !!a.writableObjectMode),
                                (this.highWaterMark = p(this, a, 'writableHighWaterMark', n)),
                                (this.finalCalled = !1),
                                (this.needDrain = !1),
                                (this.ending = !1),
                                (this.ended = !1),
                                ...
                                (this.onwrite = function (e) {
                                    !(function (e, a) {
                                        ...
                                        if (
                                            ...
                                            var n = R(t) || e.destroyed;
                                            n || t.corked || t.bufferProcessing || !t.bufferedRequest || q(e, t),
                                                o ? r.nextTick(S, e, t, n, i) : S(e, t, n, i);
                                        }
                                    })(t, e);
                                }),
                                (this.writecb = null),
                        ...
                        function x(a) {
                            ...
                            if (!r && !c.call(x, this)) return new x(a);
                            (this._writableState = new j(a, this, r)),
                                (this.writable = !0),
                            a &&
                        ...
                        function E(e, a, r, t, o, i, n) {
                            (a.writelen = t),
                                (a.writecb = n),
                                (a.writing = !0),
                                (a.sync = !0),
                                a.destroyed
                                    ? a.onwrite(new v('write'))
                                    : r
                            ...
                            if (e._writev && r && r.next) {
                                ...
                                for (; r; ) {
                                    var u = r.chunk,
                                        ...
                                        d = r.callback;
                                    if (
                                        (E(e, a, !1, a.objectMode ? 1 : u.length, u, c, d),
                                            (r = r.next),
                        ...
                        function T(e, a) {
                            e._final(function (r) {
                                a.pendingcb--, r && w(e, r), (a.prefinished = !0), e.emit('prefinish'), L(e, a);
                            });
                        }
                        function L(e, a) {
                            var t = R(a);
                            if (
                                ...
                                ((function (e, a) {
                                    ...
                                    ('function' != typeof e._final || a.destroyed
                                        ...
                                        : (a.pendingcb++, (a.finalCalled = !0), r.nextTick(T, e, a)));
                                })(e, a),
                                0 === a.pendingcb && ((a.finished = !0), e.emit('finish'), a.autoDestroy))
                            ) {
                        ...
                        e('inherits')(x, s),
                            ...
                            'function' == typeof Function.prototype[Symbol.hasInstance]
                                ? ((c = Function.prototype[Symbol.hasInstance]),
                                    Object.defineProperty(x, Symbol.hasInstance, {
                                        value: function (e) {
                                            return (
                                                !!c.call(this, e) || (this === x && e && e._writableState instanceof j)
                                            );
                                        },
                                    }))
                                : (c = function (e) {
                            ...
                            (x.prototype.write = function (e, a, t) {
                                var o,
                                ...
                                return (
                                    ...
                                    'function' == typeof a && ((t = a), (a = null)),
                                        s ? (a = 'buffer') : a || (a = i.defaultEncoding),
                                    'function' != typeof t && (t = z),
                                        i.ending
                                            ? (function (e, a) {
                                                var t = new k();
                                                w(e, t), r.nextTick(a, t);
                                            })(this, t)
                                            : (s ||
                                                (function (e, a, t, o) {
                                                    var i;
                                                    return (
                                                        null === t
                                                            ...
                                                            : 'string' == typeof t ||
                                                            a.objectMode ||
                                                            (i = new h('chunk', ['string', 'Buffer'], t)),
                                                        !i || (w(e, i), r.nextTick(o, i), !1)
                                                    );
                                                })(this, i, e, t)) &&
                                            (i.pendingcb++,
                                                (n = (function (e, a, r, t, o, i) {
                                                    if (!r) {
                                                    ...
                                                    var s = a.objectMode ? 1 : t.length;
                                                    a.length += s;
                                                    var u = a.length < a.highWaterMark;
                                                    u || (a.needDrain = !0);
                                                    if (a.writing || a.corked) {
                                                        var c = a.lastBufferedRequest;
                            ...
                            (x.prototype.uncork = function () {
                                ...
                                e.corked &&
                                (e.corked--,
                                e.writing || e.corked || e.bufferProcessing || !e.bufferedRequest || q(this, e));
                            }),
                            ...
                            (x.prototype._write = function (e, a, r) {
                                r(new m('_write()'));
                            }),
                            (x.prototype._writev = null),
                            (x.prototype.end = function (e, a, t) {
                                ...
                                return (
                                    ...
                                    (function (e, a, t) {
                                        (a.ending = !0),
                                            L(e, a),
                                        t && (a.finished ? r.nextTick(t) : e.once('finish', t));
                ...
                (function (r) {
                    (function () {
                        ...
                        function h(e) {
                            ...
                            if (null !== a) {
                                var r = e[p].read();
                                null !== r && ((e[c] = null), (e[n] = null), (e[s] = null), a(f(r, !1)));
                            }
                        }
                        ...
                        a.exports = function (e) {
                            var a,
                                t = Object.create(
                                    b,
                                    (o((a = {}), p, { value: e, writable: !0 }),
                                        o(a, n, { value: null, writable: !0 }),
                                        o(a, s, { value: null, writable: !0 }),
                                        o(a, l, { value: null, writable: !0 }),
                                        o(a, u, { value: e._readableState.endEmitted, writable: !0 }),
                                        o(a, d, {
                                            value: function (e, a) {
                                                var r = t[p].read();
                                                r
                                                    ? ((t[c] = null), (t[n] = null), (t[s] = null), e(f(r, !1)))
                                                    : ((t[n] = e), (t[s] = a));
                                            },
                                            writable: !0,
                                        }),
                                ...
                                (t[c] = null),
                                    i(e, function (e) {
                                        if (e && 'ERR_STREAM_PREMATURE_CLOSE' !== e.code) {
                                            var a = t[s];
                                            return (
                                                null !== a && ((t[c] = null), (t[n] = null), (t[s] = null), a(e)),
                                                    void (t[l] = e)
                                            );
                                        }
                                        var r = t[n];
                                        null !== r && ((t[c] = null), (t[n] = null), (t[s] = null), r(f(void 0, !0))),
                                            (t[u] = !0);
                                    }),
                                    e.on(
                                        'readable',
        ...
        29: [
            function (e, a, r) {
                ...
                function o(e, a, r) {
                    return (
                        a in e
                            ? Object.defineProperty(e, a, { value: r, enumerable: !0, configurable: !0, writable: !0 })
                            : (e[a] = r),
                            e
                    );
                }
                        ...
                        (r = [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    for (var a, r, t, o = n.allocUnsafe(e >>> 0), i = this.head, s = 0; i; )
                                        (a = i.data),
                                            (r = o),
                                            (t = s),
                                            n.prototype.copy.call(a, r, t),
                                            (s += i.data.length),
                                            (i = i.next);
                                    return o;
                                },
                                ...
                                value: function (e) {
                                    ...
                                    for (e -= t.length; (a = a.next); ) {
                                        ...
                                        if ((i === o.length ? (t += o) : (t += o.slice(0, e)), 0 === (e -= i))) {
                                            i === o.length
                                                ? (++r, a.next ? (this.head = a.next) : (this.head = this.tail = null))
                                ...
                                return s || l
                                    ? (i
                                        ...
                                        (this._writableState
                                            ...
                                            ((this._writableState.errorEmitted = !0), e.nextTick(o, this, a))
                                            : e.nextTick(o, this, a)),
                                        this)
                                            ...
                                            !i && a
                                                ? n._writableState
                                                    ? n._writableState.errorEmitted
                                                        ? e.nextTick(t, n)
                                                        : ((n._writableState.errorEmitted = !0), e.nextTick(r, n, a))
                                                    : e.nextTick(r, n, a)
                                                : i
                                                    ? (e.nextTick(t, n), i(a))
                                                    : e.nextTick(t, n);
        ...
        31: [
            function (e, a, r) {
                'use strict';
                var t = e('../../../errors').codes.ERR_STREAM_PREMATURE_CLOSE;
                function o() {}
                a.exports = function e(a, r, i) {
                    ...
                    var n = r.readable || (!1 !== r.readable && a.readable),
                        s = r.writable || (!1 !== r.writable && a.writable),
                        l = function () {
                            a.writable || c();
                        },
                        u = a._writableState && a._writableState.finished,
                        c = function () {
                            (s = !1), (u = !0), n || i.call(a);
                        },
                        d = a._readableState && a._readableState.endEmitted,
                        p = function () {
                            (n = !1), (d = !0), s || i.call(a);
                        },
                        f = function (e) {
                        ...
                        h = function () {
                            var e;
                            return n && !d
                                ? ((a._readableState && a._readableState.ended) || (e = new t()), i.call(a, e))
                                : s && !u
                                    ? ((a._writableState && a._writableState.ended) || (e = new t()), i.call(a, e))
                                    : void 0;
                        },
                        m = function () {
                            a.req.on('finish', c);
                    ...
                    return (
                        (function (e) {
                            ...
                            ? (a.on('complete', c), a.on('abort', h), a.req ? m() : a.on('request', m))
                            : s && !a._writableState && (a.on('end', l), a.on('close', l)),
                            a.on('end', p),
                            a.on('finish', c),
                        !1 !== r.error && a.on('error', f),
                            a.on('close', h),
                            function () {
                                a.removeListener('complete', c),
                                    a.removeListener('abort', h),
                                    a.removeListener('request', m),
                                a.req && a.req.removeListener('finish', c),
                ...
                a.exports = function () {
                    ...
                    var p = r.map(function (a, o) {
                        ...
                        return (function (a, r, o, i) {
                            ...
                            void 0 === t && (t = e('./end-of-stream')),
                                t(a, { readable: r, writable: o }, function (e) {
                                    if (e) return i(e);
                                    (s = !0), i();
                                });
                            var l = !1;
                            ...
                            c || (c = e), e && p.forEach(l), i || (p.forEach(l), d(c));
                        });
                    });
                    return r.reduce(u);
                };
            },
            { '../../../errors': 22, './end-of-stream': 31 },
        ],
        34: [
            function (e, a, r) {
                'use strict';
                var t = e('../../../errors').codes.ERR_INVALID_OPT_VALUE;
                a.exports = {
                    getHighWaterMark: function (e, a, r, o) {
                        var i = (function (e, a, r) {
                            return null != e.highWaterMark ? e.highWaterMark : a ? e[r] : null;
                        })(a, o, r);
                        if (null != i) {
                            if (!isFinite(i) || Math.floor(i) !== i || i < 0) throw new t(o ? r : 'highWaterMark', i);
                            return Math.floor(i);
                        }
        ...
        36: [
            function (e, a, r) {
                ((r = a.exports = e('./lib/_stream_readable.js')).Stream = r),
                    (r.Readable = r),
            ...
            function (e, a, r) {
                (r.read = function (e, a, r, t, o) {
                    var i,
                        ...
                        f = e[a + d];
                    for (
                        d += p, i = f & ((1 << -c) - 1), f >>= -c, c += s;
                        c > 0;
                        i = 256 * i + e[a + d], d += p, c -= 8
                    );
                    for (n = i & ((1 << -c) - 1), i >>= -c, c += t; c > 0; n = 256 * n + e[a + d], d += p, c -= 8);
                    if (0 === i) i = 1 - u;
                    else {
                        if (i === l) return n ? NaN : (1 / 0) * (f ? -1 : 1);
                        (n += Math.pow(2, t)), (i -= u);
                    }
                    return (f ? -1 : 1) * n * Math.pow(2, i - t);
                }),
                        ...
                        for (
                            a = Math.abs(a),
                                isNaN(a) || a === 1 / 0
                                    ...
                                    (a += n + d >= 1 ? p / l : p * Math.pow(2, 1 - d)) * l >= 2 && (n++, (l /= 2)),
                                        n + d >= c
                                            ? ((s = 0), (n = c))
                                            : n + d >= 1
                                                ? ((s = (a * l - 1) * Math.pow(2, o)), (n += d))
                                                : ((s = a * Math.pow(2, d - 1) * Math.pow(2, o)), (n = 0)));
                            o >= 8;
                            e[r + f] = 255 & s, f += h, s /= 256, o -= 8
                        );
                        for (n = (n << o) | s, u += o; u > 0; e[r + f] = 255 & n, f += h, n /= 256, u -= 8);
                        e[r + f - h] |= 128 * m;
                    });
            },
            {},
        ...
        39: [
            function (e, a, r) {
                ...
                function u(e, a, r, t, o, i, n) {
                    return (l((e + ((a & r) | (~a & t)) + o + i) | 0, n) + a) | 0;
                }
                function c(e, a, r, t, o, i, n) {
                    return (l((e + ((a & t) | (r & ~t)) + o + i) | 0, n) + a) | 0;
                }
                function d(e, a, r, t, o, i, n) {
                    return (l((e + (a ^ r ^ t) + o + i) | 0, n) + a) | 0;
                }
                function p(e, a, r, t, o, i, n) {
                    return (l((e + (r ^ (a | ~t)) + o + i) | 0, n) + a) | 0;
                }
                t(s, o),
                    (s.prototype._update = function () {
                        ...
                        var r = this._a,
                            ...
                            o = this._c,
                            i = this._d;
                        (r = u(r, t, o, i, e[0], 3614090360, 7)),
                            (i = u(i, r, t, o, e[1], 3905402710, 12)),
                            (o = u(o, i, r, t, e[2], 606105819, 17)),
                            (t = u(t, o, i, r, e[3], 3250441966, 22)),
                            (r = u(r, t, o, i, e[4], 4118548399, 7)),
                            (i = u(i, r, t, o, e[5], 1200080426, 12)),
                            (o = u(o, i, r, t, e[6], 2821735955, 17)),
                            (t = u(t, o, i, r, e[7], 4249261313, 22)),
                            (r = u(r, t, o, i, e[8], 1770035416, 7)),
                            (i = u(i, r, t, o, e[9], 2336552879, 12)),
                            (o = u(o, i, r, t, e[10], 4294925233, 17)),
                            (t = u(t, o, i, r, e[11], 2304563134, 22)),
                            (r = u(r, t, o, i, e[12], 1804603682, 7)),
                            (i = u(i, r, t, o, e[13], 4254626195, 12)),
                            (o = u(o, i, r, t, e[14], 2792965006, 17)),
                            (r = c(r, (t = u(t, o, i, r, e[15], 1236535329, 22)), o, i, e[1], 4129170786, 5)),
                            (i = c(i, r, t, o, e[6], 3225465664, 9)),
                            (o = c(o, i, r, t, e[11], 643717713, 14)),
                            (t = c(t, o, i, r, e[0], 3921069994, 20)),
                            (r = c(r, t, o, i, e[5], 3593408605, 5)),
                            (i = c(i, r, t, o, e[10], 38016083, 9)),
                            (o = c(o, i, r, t, e[15], 3634488961, 14)),
                            (t = c(t, o, i, r, e[4], 3889429448, 20)),
                            (r = c(r, t, o, i, e[9], 568446438, 5)),
                            (i = c(i, r, t, o, e[14], 3275163606, 9)),
                            (o = c(o, i, r, t, e[3], 4107603335, 14)),
                            (t = c(t, o, i, r, e[8], 1163531501, 20)),
                            (r = c(r, t, o, i, e[13], 2850285829, 5)),
                            (i = c(i, r, t, o, e[2], 4243563512, 9)),
                            (o = c(o, i, r, t, e[7], 1735328473, 14)),
                            (r = d(r, (t = c(t, o, i, r, e[12], 2368359562, 20)), o, i, e[5], 4294588738, 4)),
                            (i = d(i, r, t, o, e[8], 2272392833, 11)),
                            (o = d(o, i, r, t, e[11], 1839030562, 16)),
                            (t = d(t, o, i, r, e[14], 4259657740, 23)),
                            (r = d(r, t, o, i, e[1], 2763975236, 4)),
                            (i = d(i, r, t, o, e[4], 1272893353, 11)),
                            (o = d(o, i, r, t, e[7], 4139469664, 16)),
                            (t = d(t, o, i, r, e[10], 3200236656, 23)),
                            (r = d(r, t, o, i, e[13], 681279174, 4)),
                            (i = d(i, r, t, o, e[0], 3936430074, 11)),
                            (o = d(o, i, r, t, e[3], 3572445317, 16)),
                            (t = d(t, o, i, r, e[6], 76029189, 23)),
                            (r = d(r, t, o, i, e[9], 3654602809, 4)),
                            (i = d(i, r, t, o, e[12], 3873151461, 11)),
                            (o = d(o, i, r, t, e[15], 530742520, 16)),
                            (r = p(r, (t = d(t, o, i, r, e[2], 3299628645, 23)), o, i, e[0], 4096336452, 6)),
                            (i = p(i, r, t, o, e[7], 1126891415, 10)),
                            (o = p(o, i, r, t, e[14], 2878612391, 15)),
                            (t = p(t, o, i, r, e[5], 4237533241, 21)),
                            (r = p(r, t, o, i, e[12], 1700485571, 6)),
                            (i = p(i, r, t, o, e[3], 2399980690, 10)),
                            (o = p(o, i, r, t, e[10], 4293915773, 15)),
                            (t = p(t, o, i, r, e[1], 2240044497, 21)),
                            (r = p(r, t, o, i, e[8], 1873313359, 6)),
                            (i = p(i, r, t, o, e[15], 4264355552, 10)),
                            (o = p(o, i, r, t, e[6], 2734768916, 15)),
                            (t = p(t, o, i, r, e[13], 1309151649, 21)),
                            (r = p(r, t, o, i, e[4], 4149444226, 6)),
                            (i = p(i, r, t, o, e[11], 3174756917, 10)),
                            (o = p(o, i, r, t, e[2], 718787259, 15)),
                            (t = p(t, o, i, r, e[9], 3951481745, 21)),
                            (this._a = (this._a + r) | 0),
                            (this._b = (this._b + t) | 0),
                            (this._c = (this._c + o) | 0),
                            (this._d = (this._d + i) | 0);
            ...
            { 'hash-base': 21, inherits: 38, 'safe-buffer': 49 },
        ],
        40: [
            function (e, a, r) {
        ...
        41: [
                    ...
                    (function () {
                        ...
                        function h(e, a, r, t, o) {
                            return c
                                ...
                                .then(function (e) {
                                    return c.deriveBits(
                                        { name: 'PBKDF2', salt: a, iterations: r, hash: { name: o } },
                                        e,
                                        t << 3
                                    );
                                })
                            ...
                            if (v && 'function' == typeof r.Promise) {
                                ...
                                !(function (e, a) {
                                    ...
                                    (function (e) {
                                        ...
                                        var a = h((t = t || i.alloc(8)), t, 10, 128, e)
                                            .then(function () {
                                                return !0;
                                            })
                                            .catch(function () {
                                        ...
                                        return r ? h(e, a, o, m, v) : l(e, a, o, m, b);
                                    }),
                                    g
                                );
                            } else
            ...
            { './default-encoding': 42, './precondition': 43, './sync': 44, './to-buffer': 45, 'safe-buffer': 49 },
        ],
        42: [
            function (e, a, r) {
                (function (e, r) {
                    (function () {
                        var t;
                        if (r.process && r.process.browser) t = 'utf-8';
                        else if (r.process && r.process.version) {
                            t = parseInt(e.version.split('.')[0].slice(1), 10) >= 6 ? 'utf-8' : 'binary';
                        } else t = 'utf-8';
                        a.exports = t;
                    }.call(this));
                }.call(
        ...
        44: [
            function (e, a, r) {
                    ...
                    var s = (function (e) {
                            return 'rmd160' === e || 'ripemd160' === e
                                ...
                                : 'md5' === e
                                    ? t
                                    : function (a) {
                                        return i(e).update(a).digest();
                                    };
                        })(e),
                        l = 'sha512' === e || 'sha384' === e ? 128 : 64;
                    a.length > l ? (a = s(a)) : a.length < l && (a = n.concat([a, c], l));
                    for (var u = n.allocUnsafe(l + d[e]), p = n.allocUnsafe(l + d[e]), f = 0; f < l; f++)
                        (u[f] = 54 ^ a[f]), (p[f] = 92 ^ a[f]);
                    var h = n.allocUnsafe(l + r + 4);
                    u.copy(h, 0, 0, l),
                        (this.ipad1 = h),
                        (this.ipad2 = u),
                        (this.opad = p),
                ...
                (p.prototype.run = function (e, a) {
                    return (
                        e.copy(a, this.blocksize), this.hash(a).copy(this.opad, this.blocksize), this.hash(this.opad)
                    );
                }),
                    (a.exports = function (e, a, r, t, o) {
                        s(r, t);
                        var i = new p((o = o || 'sha1'), (e = u(e, l, 'Password')), (a = u(a, l, 'Salt')).length),
                            c = n.allocUnsafe(t),
                            f = n.allocUnsafe(a.length + 4);
                        a.copy(f, 0, 0, a.length);
                        for (var h = 0, m = d[o], b = Math.ceil(t / m), g = 1; g <= b; g++) {
                            f.writeUInt32BE(g, a.length);
                            for (var v = i.run(f, i.ipad1), y = v, k = 1; k < r; k++) {
                                y = i.run(y, i.ipad2);
                                for (var _ = 0; _ < m; _++) v[_] ^= y[_];
                            }
                            v.copy(c, h), (h += m);
                        }
                        return c;
        ...
        45: [
            function (e, a, r) {
                var t = e('safe-buffer').Buffer;
                a.exports = function (e, a, r) {
                    if (t.isBuffer(e)) return e;
                    if ('string' == typeof e) return t.from(e, a);
                    if (ArrayBuffer.isView(e)) return t.from(e.buffer);
        ...
        46: [
            function (e, a, r) {
                ...
                var u,
                    ...
                    p = -1;
                function f() {
                    d && u && ((d = !1), u.length ? (c = u.concat(c)) : (p = -1), c.length && h());
                }
                function h() {
                    if (!d) {
                        var e = l(f);
                ...
                (i.nextTick = function (e) {
                    ...
                    c.push(new m(e, a)), 1 !== c.length || d || l(h);
                }),
                    ...
                    (function () {
                        ...
                        s && s.getRandomValues
                            ? (a.exports = function (e, a) {
                                ...
                                if (e > 0)
                                    if (e > o) for (var l = 0; l < e; l += o) s.getRandomValues(t.slice(l, l + o));
                                    else s.getRandomValues(t);
        ...
        48: [
            function (e, a, r) {
                ...
                function m(e, a, r, t, o, i, n, s) {
                    return (h((e + (a ^ r ^ t) + i + n) | 0, s) + o) | 0;
                }
                function b(e, a, r, t, o, i, n, s) {
                    return (h((e + ((a & r) | (~a & t)) + i + n) | 0, s) + o) | 0;
                }
                function g(e, a, r, t, o, i, n, s) {
                    return (h((e + ((a | ~r) ^ t) + i + n) | 0, s) + o) | 0;
                }
                function v(e, a, r, t, o, i, n, s) {
                    return (h((e + ((a & t) | (r & ~t)) + i + n) | 0, s) + o) | 0;
                }
                function y(e, a, r, t, o, i, n, s) {
                    return (h((e + (a ^ (r | ~t)) + i + n) | 0, s) + o) | 0;
                }
                o(f, i),
                    (f.prototype._update = function () {
                        ...
                        for (
                            ...
                            var E, S;
                            x < 16
                                ? ((E = m(r, t, o, i, f, e[s[x]], d[0], u[x])),
                                    (S = y(k, _, w, z, j, e[l[x]], p[0], c[x])))
                                : x < 32
                                    ? ((E = b(r, t, o, i, f, e[s[x]], d[1], u[x])),
                                        (S = v(k, _, w, z, j, e[l[x]], p[1], c[x])))
                                    : x < 48
                                        ? ((E = g(r, t, o, i, f, e[s[x]], d[2], u[x])),
                                            (S = g(k, _, w, z, j, e[l[x]], p[2], c[x])))
                                        : x < 64
                                            ? ((E = v(r, t, o, i, f, e[s[x]], d[3], u[x])),
                                                (S = b(k, _, w, z, j, e[l[x]], p[3], c[x])))
                                            : ((E = y(r, t, o, i, f, e[s[x]], d[4], u[x])),
                                                (S = m(k, _, w, z, j, e[l[x]], p[4], c[x]))),
                                (r = f),
                                (f = i),
                                (i = h(o, 10)),
                                (o = t),
                        ...
                        (this._b = (this._c + i + j) | 0),
                            (this._c = (this._d + f + k) | 0),
                            (this._d = (this._e + r + _) | 0),
                            (this._e = (this._a + t + w) | 0),
                            (this._a = q);
                    }),
            ...
            { buffer: 16, 'hash-base': 21, inherits: 38 },
        ],
        49: [
            function (e, a, r) {
                var t = e('buffer'),
                ...
                o.from && o.alloc && o.allocUnsafe && o.allocUnsafeSlow ? (a.exports = t) : (i(t, r), (r.Buffer = n)),
                    ...
                    (n.alloc = function (e, a, r) {
                        ...
                        var t = o(e);
                        return void 0 !== a ? ('string' == typeof r ? t.fill(a, r) : t.fill(a)) : t.fill(0), t;
                    }),
                    (n.allocUnsafe = function (e) {
                        if ('number' != typeof e) throw new TypeError('Argument must be a number');
                        return o(e);
        ...
        50: [
            function (e, a, r) {
                var t = e('safe-buffer').Buffer;
                function o(e, a) {
                    (this._block = t.alloc(e)), (this._finalSize = a), (this._blockSize = e), (this._len = 0);
                }
                (o.prototype.update = function (e, a) {
                    'string' == typeof e && ((a = a || 'utf8'), (e = t.from(e, a)));
                    for (var r = this._block, o = this._blockSize, i = e.length, n = this._len, s = 0; s < i; ) {
                        for (var l = n % o, u = Math.min(i - s, o - l), c = 0; c < u; c++) r[l + c] = e[s + c];
                        (s += u), (n += u) % o == 0 && this._update(r);
                    }
                    ...
                    (o.prototype.digest = function (e) {
                        ...
                        (this._block[a] = 128),
                            this._block.fill(0, a + 1),
                        a >= this._finalSize && (this._update(this._block), this._block.fill(0));
                        var r = 8 * this._len;
                        if (r <= 4294967295) this._block.writeUInt32BE(r, this._blockSize - 4);
                        else {
                            var t = (4294967295 & r) >>> 0,
                                o = (r - t) / 4294967296;
        ...
        51: [
            ...
            { './sha': 52, './sha1': 53, './sha224': 54, './sha256': 55, './sha384': 56, './sha512': 57 },
        ],
        52: [
            function (e, a, r) {
                var t = e('inherits'),
                ...
                function c(e, a, r, t) {
                    return 0 === e ? (a & r) | (~a & t) : 2 === e ? (a & r) | (a & t) | (r & t) : a ^ r ^ t;
                }
                t(l, o),
                    ...
                    (l.prototype._update = function (e) {
                        ...
                        for (var p = 0; p < 80; ++p) {
                            var f = ~~(p / 20),
                                h = 0 | ((((a = t) << 5) | (a >>> 27)) + c(f, o, i, s) + l + r[p] + n[f]);
                            (l = s), (s = i), (i = u(o)), (o = t), (t = h);
                        }
                        (this._a = (t + this._a) | 0),
                            (this._b = (o + this._b) | 0),
                            (this._c = (i + this._c) | 0),
            ...
            { './hash': 50, inherits: 38, 'safe-buffer': 49 },
        ],
        53: [
            function (e, a, r) {
                var t = e('inherits'),
                ...
                t(l, o),
                    ...
                    (l.prototype._update = function (e) {
                        ...
                        for (; p < 80; ++p)
                            r[p] = ((a = r[p - 3] ^ r[p - 8] ^ r[p - 14] ^ r[p - 16]) << 1) | (a >>> 31);
                        for (var f = 0; f < 80; ++f) {
                            var h = ~~(f / 20),
                                m = (u(t) + d(h, o, i, s) + l + r[f] + n[h]) | 0;
                            (l = s), (s = i), (i = c(o)), (o = t), (t = m);
                        }
                        (this._a = (t + this._a) | 0),
                            (this._b = (o + this._b) | 0),
                            (this._c = (i + this._c) | 0),
        ...
        54: [
            ...
            { './hash': 50, './sha256': 55, inherits: 38, 'safe-buffer': 49 },
        ],
        55: [
            function (e, a, r) {
                var t = e('inherits'),
                ...
                t(l, o),
                    ...
                    (l.prototype._update = function (e) {
                        ...
                        for (; g < 64; ++g)
                            r[g] =
                                0 |
                                (((((a = r[g - 2]) >>> 17) | (a << 15)) ^ ((a >>> 19) | (a << 13)) ^ (a >>> 10)) +
                                    r[g - 7] +
                                    f(r[g - 15]) +
                                    r[g - 16]);
                        for (var v = 0; v < 64; ++v) {
                            var y = (b + p(l) + u(l, h, m) + n[v] + r[v]) | 0,
                                k = (d(t) + c(t, o, i)) | 0;
                            (b = m), (m = h), (h = l), (l = (s + y) | 0), (s = i), (i = o), (o = t), (t = (y + k) | 0);
                        }
                        (this._a = (t + this._a) | 0),
                            (this._b = (o + this._b) | 0),
                            (this._c = (i + this._c) | 0),
        ...
        56: [
            function (e, a, r) {
                ...
                t(l, o),
                    ...
                    (l.prototype._hash = function () {
                        ...
                        function a(a, r, t) {
                            e.writeInt32BE(a, t), e.writeInt32BE(r, t + 4);
                        }
                        return (
            ...
            { './hash': 50, './sha512': 57, inherits: 38, 'safe-buffer': 49 },
        ],
        57: [
            function (e, a, r) {
                var t = e('inherits'),
                ...
                function f(e, a) {
                    return ((e >>> 1) | (a << 31)) ^ ((e >>> 8) | (a << 24)) ^ (e >>> 7);
                }
                function h(e, a) {
                    return ((e >>> 1) | (a << 31)) ^ ((e >>> 8) | (a << 24)) ^ ((e >>> 7) | (a << 25));
                }
                function m(e, a) {
                    return ((e >>> 19) | (a << 13)) ^ ((a >>> 29) | (e << 3)) ^ (e >>> 6);
                }
                function b(e, a) {
                    return ((e >>> 19) | (a << 13)) ^ ((a >>> 29) | (e << 3)) ^ ((e >>> 6) | (a << 26));
                }
                function g(e, a) {
                    return e >>> 0 < a >>> 0 ? 1 : 0;
                }
                t(l, o),
                    ...
                    (l.prototype._update = function (e) {
                        for (
                            ...
                            (a[q] = e.readInt32BE(4 * q)), (a[q + 1] = e.readInt32BE(4 * q + 4));
                        for (; q < 160; q += 2) {
                            var R = a[q - 30],
                                T = a[q - 30 + 1],
                                L = f(R, T),
                                A = h(T, R),
                                B = m((R = a[q - 4]), (T = a[q - 4 + 1])),
                                M = b(T, R),
                                O = a[q - 14],
                                I = a[q - 14 + 1],
                                C = a[q - 32],
                                ...
                                P = (A + I) | 0,
                                N = (L + O + g(P, A)) | 0;
                            (N = ((N = (N + B + g((P = (P + M) | 0), M)) | 0) + C + g((P = (P + U) | 0), U)) | 0),
                                (a[q] = N),
                                (a[q + 1] = P);
                        }
                        ...
                        (this._al = (this._al + k) | 0),
                            ...
                            (this._ah = (this._ah + r + g(this._al, k)) | 0),
                            (this._bh = (this._bh + t + g(this._bl, _)) | 0),
                            (this._ch = (this._ch + o + g(this._cl, w)) | 0),
        ...
        58: [
            function (e, a, r) {
                ...
                e('inherits')(o, t),
                    (o.Readable = e('readable-stream/lib/_stream_readable.js')),
                    (o.Writable = e('readable-stream/lib/_stream_writable.js')),
                    (o.Duplex = e('readable-stream/lib/_stream_duplex.js')),
                    (o.Transform = e('readable-stream/lib/_stream_transform.js')),
                    (o.PassThrough = e('readable-stream/lib/_stream_passthrough.js')),
                    (o.finished = e('readable-stream/lib/internal/streams/end-of-stream.js')),
                    (o.pipeline = e('readable-stream/lib/internal/streams/pipeline.js')),
                    (o.Stream = o),
                    (o.prototype.pipe = function (e, a) {
                        var r = this;
                        function o(a) {
                            e.writable && !1 === e.write(a) && r.pause && r.pause();
                        }
                        function i() {
                        ...
                        r.on('data', o),
                            e.on('drain', i),
                        e._isStdio || (a && !1 === a.end) || (r.on('end', s), r.on('close', l));
                        var n = !1;
                        function s() {
                            n || ((n = !0), e.end());
                        }
                        ...
                        function u(e) {
                            if ((c(), 0 === t.listenerCount(this, 'error'))) throw e;
                        }
                        function c() {
            ...
            },
            {
                events: 20,
                inherits: 38,
                'readable-stream/lib/_stream_duplex.js': 60,
                'readable-stream/lib/_stream_passthrough.js': 61,
                'readable-stream/lib/_stream_readable.js': 62,
                'readable-stream/lib/_stream_transform.js': 63,
                'readable-stream/lib/_stream_writable.js': 64,
                'readable-stream/lib/internal/streams/end-of-stream.js': 68,
                'readable-stream/lib/internal/streams/pipeline.js': 70,
            },
        ],
        59: [
            function (e, a, r) {
        ...
        60: [
            ...
            { './_stream_readable': 62, './_stream_writable': 64, _process: 46, dup: 23, inherits: 38 },
        ],
        61: [
            function (e, a, r) {
                arguments[4][24][0].apply(r, arguments);
            },
            { './_stream_transform': 63, dup: 24, inherits: 38 },
        ],
        62: [
            function (e, a, r) {
            ...
            },
            {
                '../errors': 59,
                './_stream_duplex': 60,
                './internal/streams/async_iterator': 65,
                './internal/streams/buffer_list': 66,
                './internal/streams/destroy': 67,
                './internal/streams/from': 69,
                './internal/streams/state': 71,
        ...
        63: [
            ...
            { '../errors': 59, './_stream_duplex': 60, dup: 26, inherits: 38 },
        ],
        64: [
            function (e, a, r) {
        ...
        65: [
            ...
            { './end-of-stream': 68, _process: 46, dup: 28 },
        ],
        66: [
            function (e, a, r) {
                arguments[4][29][0].apply(r, arguments);
            },
            { buffer: 16, dup: 29, util: 15 },
        ],
        67: [
            function (e, a, r) {
        ...
        70: [
            ...
            { '../../../errors': 59, './end-of-stream': 68, dup: 33 },
        ],
        71: [
            function (e, a, r) {
            ...
            function (e, a, r) {
                ...
                function i(e) {
                    ...
                    switch (
                        ((this.encoding = (function (e) {
                            ...
                            if ('string' != typeof a && (t.isEncoding === o || !o(e)))
                        ...
                        case 'utf16le':
                            (this.text = l), (this.end = u), (a = 4);
                            break;
                        case 'utf8':
                            (this.fillLast = s), (a = 4);
                            break;
                        case 'base64':
                            (this.text = c), (this.end = d), (a = 3);
                            break;
                        default:
                ...
                function s(e) {
                    var a = this.lastTotal - this.lastNeed,
                        r = (function (e, a, r) {
                            if (128 != (192 & a[0])) return (e.lastNeed = 0), '�';
                            if (e.lastNeed > 1 && a.length > 1) {
                                if (128 != (192 & a[1])) return (e.lastNeed = 1), '�';
                                if (e.lastNeed > 2 && a.length > 2 && 128 != (192 & a[2])) return (e.lastNeed = 2), '�';
                            }
                        })(this, e);
                    return void 0 !== r
                        ? r
                        : this.lastNeed <= e.length
                            ? (e.copy(this.lastChar, a, 0, this.lastNeed),
                                this.lastChar.toString(this.encoding, 0, this.lastTotal))
                            : (e.copy(this.lastChar, a, 0, e.length), void (this.lastNeed -= e.length));
                }
                function l(e, a) {
                    if ((e.length - a) % 2 == 0) {
                    ...
                    return (
                        (this.lastNeed = 1),
                            ...
                            e.toString('utf16le', a, e.length - 1)
                    );
                }
                function u(e) {
                    ...
                    if (this.lastNeed) {
                        ...
                        return a + this.lastChar.toString('utf16le', 0, r);
                    }
                    return a;
                }
                function c(e, a) {
                    ...
                    return 0 === r
                        ...
                        : ((this.lastNeed = 3 - r),
                            ...
                            e.toString('base64', a, e.length - r));
                }
                function d(e) {
                    var a = e && e.length ? this.write(e) : '';
                ...
                (r.StringDecoder = i),
                    ...
                    (i.prototype.text = function (e, a) {
                        var r = (function (e, a, r) {
                            ...
                            if (--t < r || -2 === o) return 0;
                            if ((o = n(a[t])) >= 0) return o > 0 && (e.lastNeed = o - 2), o;
                            if (--t < r || -2 === o) return 0;
                            if ((o = n(a[t])) >= 0) return o > 0 && (2 === o ? (o = 0) : (e.lastNeed = o - 3)), o;
                            return 0;
                        })(this, e, a);
                        if (!this.lastNeed) return e.toString('utf8', a);
                        this.lastTotal = r;
                        var t = e.length - (r - this.lastNeed);
                        return e.copy(this.lastChar, 0, t), e.toString('utf8', a, t);
                    }),
                        ...
                        a.exports = function (e, a) {
                            ...
                            return function () {
                                if (!t) {
                                    ...
                                    r('traceDeprecation') ? console.trace(a) : console.warn(a), (t = !0);
                                }
